Data is taken from the toRvik package in R and then transferred over to Python. The data was too big to upload to Github and has been put in a Google Drive. 
